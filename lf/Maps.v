...
Theorem t_update_neq : forall (A : Type) (m : total_map A) x1 x2 v,
  ...
  (x1 !-> v ; m) x2 = m x2.
Proof.
  intros. unfold t_update. destruct (String.eqb_spec x1 x2) as [Heq | Hneq'].
  - contradiction.
  - reflexivity.
Qed.
...
Theorem t_update_permute : forall (A : Type) (m : total_map A)
  ...
  (x2 !-> v2 ; x1 !-> v1 ; m).
Proof.
  intros. unfold t_update. apply functional_extensionality. intros x. destruct (String.eqb_spec x1 x)
  as [HeqX1 | HneqX1].
  - destruct (String.eqb_spec x2 x) as [HeqX2 | HneqX2].
